...
namespace INotifyLibrary.Util
{
    ...
    public static class INotifyConstant
    {
    ...
    public static class IKPackageProfileConstant
    {
        ...
        public const string DefaultAllInPackageIdLogoFilePath = @"Z:\SideKick\INotify\INotify\Assets\DefaultIcon\DefaultNotificationIcon.png";
    }

    public static class IKSpaceConstant
    {
        public const string DefaultWorkSpaceIcon = @"Z:\SideKick\INotify\INotify\Assets\DefaultIcon\DefaultWorkSpaceIcon.png";
    }
